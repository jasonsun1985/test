		...
		class Producer implements Runnable {
			public void run() {
				try {
					while (true) {
						// 生产苹果
						System.out.println("生产者准备生产苹果：" + new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").format(new Date()));
						basket.produce();
						System.out.println("生产者生产苹果完毕：" + new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").format(new Date()));
		...
		class Consumer implements Runnable {
			public void run() {
				try {
					while (true) {
						// 消费苹果
						System.out.println("消费者准备消费苹果：" + new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").format(new Date()));
						basket.consume();
						System.out.println("消费者消费苹果完毕：" + new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").format(new Date()));
