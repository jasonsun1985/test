 ...
 * generated in the com.collect.ws.autoGenerate package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValueResponse_QNAME = new QName("http://ws.collect.com/", "getValueResponse");
    private final static QName _GetValue_QNAME = new QName("http://ws.collect.com/", "getValue");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.collect.ws.autoGenerate
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.collect.com/", name = "getValueResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.collect.com/", name = "getValue")
