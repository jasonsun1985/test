...
public class TestSnmp {
    ...
    public void sendUdpMessage(Boolean syn, final Boolean bro, PDU pdu, String addr)
            throws IOException {
        // 生成目标地址对象
...
//            
//            System.out.println(response.getResponse().getType());
            /**
             * 输出结果：
    ...
    public static void main(String[] args) {
        ...
        TestSnmp manager = new TestSnmp(ver2c);
        // 构造报文
        PDU pdu = new PDU();
         //PDU pdu = new ScopedPDU();
        // 设置要获取的对象ID，这个OID代表远程计算机的名称
//        OID oids = new OID("1.3.6.1.2.1.1.5.0");
//        OID oids = new OID("1.3.6.1.2.1.25.2.2.0");//获取内存大小
        OID oids = new OID("1.3.6.1.2.1.2.1.0");//网络接口的数目
...
//            manager.sendMessage(false, true, pdu, "udp:172.17.160.182/161");//192.168.1.233 WinServer2008服务器
            manager.sendUdpMessage(false, true, pdu, "udp:172.17.160.182/161");//192.168.1.233 WinServer2008服务器
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
