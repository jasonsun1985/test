...
public class Snmp4jFirstDemo {
	...
	public void sendMessage(Boolean syn, final Boolean bro, PDU pdu, String addr) throws IOException {
		...
		if (!syn) {
			 ...
			 * request(���͵�����):GET[requestID=632977521, errorStatus=Success(0),
			 * errorIndex=0, VBS[1.3.6.1.2.1.1.5.0 = Null]]
			 * response(���ص���Ӧ):RESPONSE[requestID=632977521,
			 * errorStatus=Success(0), errorIndex=0, VBS[1.3.6.1.2.1.1.5.0 =
			 * WIN-667H6TS3U37]]
			 * 
			 */
			PDU pduRes = response.getResponse();
			System.out.println("1.3.6.1.2.1.1.5.0 ����ֵ : " + pduRes.getVariable(new OID("1.3.6.1.2.1.1.5.0")).toString());
			System.out.println("1.3.6.1.2.1.1.1.0 ����ֵ : " + pduRes.getVariable(new OID("1.3.6.1.2.1.1.1.0")).toString());
		} else {
			// ���ü�������
			ResponseListener listener = new ResponseListener() {
				...
				public void onResponse(ResponseEvent event) {
					...
					System.out.println("Asynchronise(�첽) message(��Ϣ) from(����) " + event.getPeerAddress() + "\r\n"
	...
	public static void main(String[] args) {
		...
		try {
			// ������Ϣ �������һ������Ҫ���͵�Ŀ���ַ
			// manager.sendMessage(false, true, pdu,
			// "udp:192.168.1.229/161");//192.168.1.229 Linux������
//			manager.sendMessage(true, true, pdu, "udp:172.17.161.235/162");
			manager.sendMessage(false, true, pdu, "udp:172.17.160.182/161");
//			manager.sendMessage(true, false, pdu, "udp:172.17.160.182/161");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
