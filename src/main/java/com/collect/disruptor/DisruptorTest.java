...
public class DisruptorTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        RingBuffer<MessageEvent> ringBuffer = createSingleProducer(MessageEvent.EVENT_FACTORY, BUFFER_SIZE,new YieldingWaitStrategy());
        ...
        executors.shutdown();
//        log.info(String.format("Run %d, Disruptor=%,d ops/sec%n", 1, opsPerSecond) + " use： " + end);
        System.out.println(String.format("Run %d, Disruptor=%,d ops/sec%n", 1, opsPerSecond) + " use： " + end);
    }
